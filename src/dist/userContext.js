...
exports.UserProvider = function (_a) {
    ...
    var _b = react_1.useState(null), flashMessage = _b[0], setFlashMessage = _b[1];
    ...
    var handleLogin = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
        var res, _a, token, user_1, error_1;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    setFlashMessage({
                        type: "error",
                        message: ((_c = (_b = error_1.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.message) ||
